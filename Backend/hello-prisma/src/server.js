...
app.use(cors({ origin: ['https://peter-metcalfe.co.uk', 'https://leonardo-rc.com', 'https://www.leonardo-rc.com', 'http://127.0.0.1:5500'] }));

app.use(express.json());
app.use((err, req, res, next) => {
    res.setHeader('Access-Control-Allow-Origin', 'https://leonardo-rc.com', 'https://www.leonardo-rc.com', 'http://127.0.0.1:5500');
